module github.com/gtsteffaniak/filebrowser/backend/build
...
// air (via Hugo) and golangci-lint need different github.com/gobwas/glob APIs; pin Hugo 0.164 + glob 0.2.3.
exclude (
