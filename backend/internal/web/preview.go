...
func getDirectoryPreview(ctx context.Context, r *http.Request, d *Context, frameIndex int) (*iteminfo.ExtendedFileInfo, error) {
...
func PreviewHelperFunc(w http.ResponseWriter, r *http.Request, d *Context) (int, error) {
	ctx := r.Context()
	if d.Ctx != nil {
		ctx = d.Ctx
	}
