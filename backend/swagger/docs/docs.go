    ...
    "paths": {
        ...
        "/api/media/stream": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Raw media content (inline)",
                        "schema": {
                            "type": "file"
                        }
                    },
                    "403": {
                        "description": "Missing or invalid stream token, or non-media file",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/media/transcode": {
            "get": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "User transcode limit reached",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "416": {
                        "description": "Range requests not supported",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "503": {
                        "description": "System transcode limit reached",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/api/media/transcode/sessions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Source name for start eligibility check",
                        "name": "source",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "File path for start eligibility check",
                        "name": "file",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "iteminfo.ExtendedFileInfo": {
            ...
            "properties": {
                ...
                "streamToken": {
                    "description": "opaque token for inline media streaming via /media/stream",
                    "type": "string"
                },
                "subtitles": {
