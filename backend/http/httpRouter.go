...
func StartHttp(ctx context.Context, storage *bolt.BoltStore, shutdownComplete chan struct{}) {
	...
	api.HandleFunc("GET /preview", withTimeout(30, withUserHelper(previewHandler)))
	...
	publicAPI.HandleFunc("GET /preview", withTimeout(30, withHashFileHelper(publicPreviewHandler)))
