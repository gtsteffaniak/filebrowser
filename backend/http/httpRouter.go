...
func StartHttp(ctx context.Context, storage *bolt.BoltStore, shutdownComplete chan struct{}) {
	...
	api.HandleFunc("GET /resources/preview", withTimeout(15*time.Second, withUserHelper(previewHandler)))
	...
	publicApi.HandleFunc("GET /resources/preview", withTimeout(15*time.Second, withHashFileHelper(publicPreviewHandler)))
